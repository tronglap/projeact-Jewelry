...
@section('title')
    Create Blog Category - {{ Auth::user()->name }}
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="h3 mb-0 text-gray-800">Blog Category Form</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            @if (session('message'))
                                @if (session('message') == 'Create Blog Category Success!')
                            ...
                            @endif
                            <!-- form start -->
                            <form role="form" method="post" action="{{ route('admin.blogCategories.store') }}">
                                <div class="card-body">
