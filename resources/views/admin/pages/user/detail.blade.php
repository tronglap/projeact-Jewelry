    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Detail User Form</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Detail User Form</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <form role="form" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ old('phone') ?? $data['phone'] }}" name="phone"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control" id="address">{{ old('address') ?? $data['address'] }}</textarea>
                                        @error('address')
                                            <span class="text-danger">{{ $message }}<span>
                                                @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control" id="role">
                                            ...
                                            <option {{ old('role', $data['role']) == '1' ? 'selected' : '' }}
                                                value="1">Admin</option>
                                            <option {{ old('role', $data['role']) == '2' ? 'selected' : '' }}
                                                value="2">Staff</option>
                                            <option {{ old('role', $data['role']) == '0' ? 'selected' : '' }}
