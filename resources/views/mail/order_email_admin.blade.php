...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <title>Có 1 đơn hàng vừa đặt</title>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding: 0 2.5em; text-align: left;">
                                        <div class="text">
                                            <p style="color: #000;">Customer Name: {{ $order->user->name }}</p>
                                            <p style="color: #000;">Customer Email: {{ $order->user->email }}</p>
                                            <p style="color: #000;">Customer Phone: {{ $order->user->phone }}</p>
                                            <p style="color: #000;">Customer Address: {{ $order->user->address }}</p>
                                            <h3>Order Details</h3>
                                        </div>
                                    </td>
                                </tr>
